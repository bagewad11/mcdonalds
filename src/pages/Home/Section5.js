...
function Section5() {
  return (
    <>
      <section className="shop_section" id="contact">
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              <h4>Download mobile App</h4>
              <h2>Deliciousness At Your Fingertips</h2>
              <Link to="https://apps.apple.com/us/app/mcdonalds/id922103212">
                <img
                  src={StoreIOS}
                  alt="IOS"
              ...
              <Link to="https://play.google.com/store/apps/details?id=com.mcdonalds.app&hl=en&pli=1">
                <img
                  src={StoreGoogle}
                  alt="Android"
                  className="img-fluid store me-3"
